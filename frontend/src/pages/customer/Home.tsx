          ...
          <div className="p-0 sm:p-0">
            <div className="relative overflow-hidden rounded-[1.25rem]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                <div className="inline-flex max-w-full flex-col rounded-[1rem] border border-white/15 bg-black/55 px-3 py-2 shadow-[0_8px_24px_rgba(0,0,0,0.35)] backdrop-blur-sm sm:px-4 sm:py-3">
